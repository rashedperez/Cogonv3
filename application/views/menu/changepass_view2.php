									...
									<div class="m-sm-4">
										<form>
											<div class="form-group">
												...
												<input class="form-control form-control-lg" type="email" name="email" placeholder="Enter New Password" />
											</div>
                                            <div class="form-group">
												<label>Confirm New Password</label>
												<input class="form-control form-control-lg" type="email" name="email" placeholder=" Confirm New Password" />
											</div>
